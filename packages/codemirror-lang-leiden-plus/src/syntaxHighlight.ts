...
export const leidenPlusHighlighting: NodePropSource = styleTags({
    "GapNums!": [leidenTags.gapNumber, t.emphasis],

    "Illegible/...": leidenTags.illegible,
    "Vestige/... VestigStandalone": [leidenTags.vestiges, leidenTags.test],
    "LostLines/...": [leidenTags.lostLines, leidenTags.test],
    "Vacat/...": [leidenTags.vacat, leidenTags.test],


    // block elements
    "EditionStart": leiden.blockLevel1,
    "EditionStart/LanguageId": leiden.blockLevel1Attr,
    "Div/Num Div/Ref Div/Subtype": [leiden.blockLevel2Attr, t.emphasis],
    ...
    "Foreign/LanguageId": leiden.foreignLanguageId, // TODO: make visible in grammar
    ...
    "OrthoReg/Infix OrthoReg/MultiInfix": [leiden.app1, leiden.test],
    ...
    "ScribalCorrection/Infix": [leiden.app2, t.emphasis, leiden.test],
    ...
    "AlternateReading/Infix AlternateReading/MultiInfix": [leiden.app3, leiden.test],
    ...
    "SpellingCorrection/Infix": [leiden.app4, leiden.test],
    ...
    "EditorialCorrection/Infix EditorialCorrection/MultiInfix": [leiden.app5, leiden.test],
