...
export const leidenHighlightStyleDark = HighlightStyle.define([
    ...
    // Text Loss & Uncertainty
    {tag: leidenTags.lost,
        color: "#E67373"},
    {tag: [leidenTags.illegible, leidenTags.vestiges, leidenTags.lostLines, leidenTags.vacat, leidenTags.gap],
        color: "#BF6060"},
    {tag: leidenTags.unclear,
        opacity: 0.75}, // Now just opacity modifier
    ...
    // Foreign Text - Brightened for better readability
    {tag: leidenTags.foreign,
        color: "#E4B6E4"}, // Much brighter purple
    {tag: leidenTags.foreignLanguageId,
        color: "#D49ED4"}, // Brighter deep purple

    {tag: leidenTags.surplus,
        color: "#dda836"},

    // Insertions - Made more visible
    {tag: leidenTags.insertionAbove,
        color: "#FF9F7F"}, // Bright coral
    {tag: leidenTags.insertionBelow,
        color: "#FFB499"},
    {tag: leidenTags.insertionMargin,
        color: "#FFCAB3"},
...
// export const leidenScholarLight = HighlightStyle.define([
//     ...defaultHighlightStyle.specs,
//
//     {tag: leidenTags.gapNumber,
//         filter: "brightness(130%)"},
...
//     // Text Loss & Uncertainty
//     {tag: leidenTags.lost,
//         color: "#b91c1c"}, // Rich but not harsh
//     {tag: [leidenTags.illegible, leidenTags.vestiges, leidenTags.lostLines, leidenTags.vacat, leidenTags.gap],
//         color: "#9b2c2c"},
//     {tag: leidenTags.unclear,
//         opacity: 0.65},
...
//     {tag: leidenTags.erasureContent,
//         color: "#c2410c",
//         textDecorationColor: "rgba(194,65,12,0.5)",
//         textDecoration: "line-through"},
//
//     // Supplied Text
//     {tag: leidenTags.supplied,
...
//
//     // Editorial notes
//     {tag: [leidenTags.editorialComment, leidenTags.editorialNote],
//         color: "#4a5568"},
//
//     // Foreign Text
//     {tag: leidenTags.foreign,
